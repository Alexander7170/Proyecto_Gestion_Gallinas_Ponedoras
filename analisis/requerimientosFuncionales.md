## Lista de requerimientos funcionales del MVP

* El sistema debe permitir el logueo de usuarios registrados
* El sistema debe permitir la modificacion de los propios datos personales de los usuarios
* El sistema debe permitir cerrar la sesion de usuarios logueados 
* El sistema debe permitir realizar las operaciones CRUD de las ventas
* El sistema debe permitir realizar las operaciones CRUD de los gastos
